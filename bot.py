...
TOKEN = '7603709775:AAEDAc2I1lBqlbcCUJKR00bikaaThX8X0Mc'
...
@bot.message_handler(func=lambda message: message.text in ['Банки', 'Аптеки', 'Лікарні'])
def category_selected(message):
    ...
    bot.send_message(message.chat.id, f"Адреси для категорії {category}:", reply_markup=markup)
